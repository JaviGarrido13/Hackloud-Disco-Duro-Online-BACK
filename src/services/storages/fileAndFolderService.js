...
export const listFilesAndFoldersService = async () => {
    ...
    if (!fs.existsSync(uploadDirectory)) {
        throw generateErrorUtils (404,"DIRECTORY_NOT_FOUND", "La carpeta de almacenamiento no existe")
    }
    ...
    try {
        ...
        throw generateErrorUtils(500, 'DIRECTORY_READ_FAILED', 'No se pudo leer el contenido de la carpeta');
    }
